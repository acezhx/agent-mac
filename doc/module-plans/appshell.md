...
当前最小链路支持 Agent 列表、创建表单、选择 Agent、编辑名称、编辑模型 provider/name、
...
- Agent 编辑页当前支持名称、模型 provider/name、system prompt 和 knowledge/skills/tools 选择；
